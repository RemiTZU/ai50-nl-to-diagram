...
SYMATTR Value ADG5412
SYMATTR Prefix X
SYMATTR SpiceModel ADG5412.sub
SYMATTR Value2 ADG5412
SYMATTR Description High Voltage Latch-up Proof Quad SPST Switches \n(Switch shown for a logic 1 input)
PIN 0 -128 TOP 8
PINATTR PinName Vdd
