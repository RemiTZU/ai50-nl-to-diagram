...
SYMATTR Value ADG842
SYMATTR Prefix X
SYMATTR SpiceModel ADG842.sub
SYMATTR Value2 ADG842
SYMATTR Description <0.28 Ohm CMOS 1.65 V to 3.6 V SPST Switches \n(Switch shown for a logic 0 input)
PIN 0 -128 TOP 8
PINATTR PinName Vdd
